...
/// 
/// </summary>
/// @param grupe1 studentu grupe
/// @param v1 studentu grupes dydis
...
/// Rusiavimas studentu grupe
/// 
/// Rusiuoja pagal galutini pazymi
/// @param grupe1 studentu grupe
/// @param protingi nauja protingu studentu grupe
/// @param tinginiai nauja tinginiu studentu grupe
/// @param laikas vektorius, kuris saugos sugaista laika, vykdant kodo dali
/// @param atsakymas raide, kuri nurodys, koki galutini pazymi naudoti, apskaiciuota su vidurkiu ar mediana
...
/// Patobulintas studedntu grupes rusiavimas
/// 
/// Pagal galutini pazymi
/// @param grupe_vector studentu grupe
/// @param tinginiai_vector nauja tinginiu studentu grupe
/// @param laikas_vector vektorius, kuris saugos sugaista laika, vykdant kodo dali
/// @param atsakymas raide, kuri nurodys, koki galutini pazymi naudoti, apskaiciuota su vidurkiu ar mediana
...
/// Spausdina ir isrusiuoja
/// 
/// faile pateikiami tokie duomenys: studento vardas, pavarde, galutinis pazymys
/// @param v1 studentu grupes dydis
/// @param atsakymas raide, kuri nurodys, koki galutini pazymi naudoti, apskaiciuota su vidurkiu ar mediana
/// @param sarasas studentu grupe
/// @param laikas_vector vektorius, kuris saugos sugaista laika, vykdant kodo dali
/// @param pav studentu grupes pavadinimas:protingi ar tinginiai
/// @see Naudojima rusiavimui funkcija rusiuotiVidurki() ir rusiuotiMediana()
...
/// 
/// faile pateikiami tokie duomenys: studento vardas, pavarde, galutinis pazymys
/// @param atsakymas - raide, kuri nurodys, koki galutini pazymi naudoti, apskaiciuota su vidurkiu ar mediana, ar abu pazymius
/// @param grupe1 studentu grupe
...
/// 
/// pateikiant tokius duomenis apie studentus: vardas, pavarde, galutinis pazymys/pazymiai
/// @param atsakymas - raide, kuri nurodys, koki galutini pazymi naudoti, apskaiciuota su vidurkiu ar mediana, ar abu pazymius
/// @param grupe1 studentu grupe
...
/// Saugoja informacija apie studentus
/// 
/// </summary>
/// @param studentuSkaicius
...
/// Saugoja informacija apie studdentus
/// 
/// Nd ir egzamino pazymiai sugeneruojami automatiskai
/// @param studentuSkaicius
/// @param grupe studentu grupe
...
/// Palyginimas
/// 
/// lygina dvieju studentu galutinius pazymius, apskaiciuotus su mediana
...
/// Palyginimas
/// 
/// lygina dvieju studentu galutinius pazymius, apskaiciuotus su vidurkiu
/// @param a pirmas studentas
/// @param b antras studentas
/// @return true arba false
